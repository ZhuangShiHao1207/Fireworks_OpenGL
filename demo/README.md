...
<div style="display: flex; gap: 10px;">
  <img src="demo\烟花1.png" width="30%" />
  <img src="demo\烟花2.png" width="30%" />
  <img src="demo\烟花3.png" width="30%" />
</div>

<div style="display: flex; gap: 10px;">
  <img src="demo\烟花4.png" width="30%" />
  <img src="demo\烟花5.png" width="30%" />
</div>
...
![开启雾效之后](demo\开启雾效之后.png)

可以看到在开启雾效之后远处的水面相比近处会更加模糊，雾浓度可以调整（为了保证演示视频效果，此处参数比较保守）
