...
bool TextRenderer::LoadFont(const std::string& fontPath, GLuint fontSize) {
    ...
    std::vector<unsigned int> chineseChars = {
        ...
        // 第二句: 展示天空盒、地面与模型
        0x5C55, 0x793A, 0x5929, 0x7A7A, 0x76D2, 0x3001, 0x5730, 0x9762, 0x4E0E, 0x6A21, 0x578B,

        // 第三句: 单独展示部分烟花
        0x5355, 0x72EC, 0x5C55, 0x793A, 0x90E8, 0x5206, 0x70DF, 0x82B1,

        // 第四句: 随机发射烟花
        0x968F, 0x673A, 0x53D1, 0x5C04, 0x70DF, 0x82B1,

        // 第五句: 点击地面发射烟花
        0x70B9, 0x51FB, 0x5730, 0x9762, 0x53D1, 0x5C04, 0x70DF, 0x82B1,
